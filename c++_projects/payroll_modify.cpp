...
void Employee::n_name(){
    cout<<"Enter the New Name else <Enter> :";
        gets(temp);
        strcpy(name,strlen(temp)!=0?temp:name);
}
void Employee::n_age(){
        cout<<"Enter the Age :";
        cin>>age;
...
void Employee::n_depart(){
        cout<<"Enter the Department else <Enter> :";
        gets(temp);
...
void Employee::n_design(){
        cout<<"Enter the Department else <Enter> :";
        gets(temp);
        strcpy(design,strlen(temp)!=0?temp:design);
}
void Employee::n_sal(){
...
void Employee::details(){
    cout<<"Select Which Parameters to Modify:\n1.Name\n2.Age\n3.Experience\n4.Department\n5.Designation\n:";
    cin>>ch;
    switch(ch){
        case 1:
        n_name();
...
void Employee::modify(){
     ...
     cin>>i;
     if(m[i]!=0){
        cout<<"Select the option to modify:\n1.Edit Employee Details\n2.Edit Salary\n3.Change Grade\n";
        cin>>i;
        switch(i){
            case 1:
            details();
...
// float update_sal(int c,int b){
//     return c!=-1?c:b;
// }
void Employee::grade1(float c=-1){
     grad=1;
     base=50000;
    //  base=update_sal(c,base);
     day=base/30;
     da=0.32*base;
     hra=0.28*base;
     ma=0.06*base;
...
void Employee::grade2(float c=-1){
     grad=2;
     base=25000;
    //  base=update_sal(c,base);
     day=base/30;
...
void Employee::grade3(float c=-1){
     grad=3;
     day=base/30;
    //  base=update_sal(c,base);
     da=0.32*base;
...
void Employee::grade4(float c=-1){
     grad=4;
     base=10000;
    //  base=update_sal(c,base);
     day=base/30;
...
void Employee::grade5(float c=-1){
     grad=5;
     tds=0;
     base=5000;
    //  base=update_sal(c,base);
