...
class Employee{
    ...
    int id,age,exp;
    int grad=0; 
    char name[100],depart[100],pan[15],design[100];
...
void readrec(){
    c=0;
    ifstream file("payo.txt");   //to read input from file
    if(!file)
...
void update(){
     ofstream file("payo.txt");    //to give output to file
     for(int i=0;i<c;i++){
...
void display(){
        ...
        cout<<"ID   Name\t   Age\t Experience\tDepartment\tDesignation"<<endl;
        while(i<c){
        gotoxy(i+2,0);
        cout<<o[i].id;
        gotoxy(i+2,5);
...
/*Project -4 Employee Payroll Management System
    Group 15
    AP21110011239 - P Asish Manoj Reddy
    AP21110011241 - N Siva Naga Malleswar
    AP21110011238 - G Ajay Kumar
    AP21110011240 - K Charandeep Chowdary
*/