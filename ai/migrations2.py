    ...
    for _ in range(num_jobs):
        ...
        while True:
            ...
            if network[source_node]['capacity']>0:
                ...
                #using bfs to check neighbours and their neighbours if capacity full
                ...
                while neighbors_q:
                    ...
                    for neighbor in network[current_node]['neighbors']:
                        if neighbor not in visited and neighbor not in neighbors_q:
...
#to give same network by clearing existing old jobs and give new jobs in each iteration.
